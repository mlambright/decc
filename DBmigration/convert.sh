...
mysqldump -h 173.255.254.42 -u mlambright decc clients contacts clients_has_contacts billable projects types orders parts batches --compatible=postgresql --skip-add-locks > "$STOREDIR/decc/DBmigration/dumps/deccdump$DATEFORM.sql"
echo 'dumped'
